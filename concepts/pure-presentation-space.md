...
The pure presentation space records labeled violations that arise only from
...
quotiented out to obtain the presentation-independent labeled obstruction.
...
be the labeled violation map. A pure presentation is a generator combination
...
It is the denominator in the [labeled obstruction
