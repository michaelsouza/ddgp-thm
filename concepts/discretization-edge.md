...
The initial clique on $v_1, \dots, v_K$ supplies the seed distances needed to fix the coordinate system; depending on convention, those seed edges may be included together with $E_D$.
