...
\end{enumerate}
This yields exactly $|\Xi_F| = 2^{n-K}$, recovering the positive result of Abud et~al.~\cite{abud2024impossible}. Thus the rank-count formula agrees with clique-based DMDGP and Combinatorial DDGP counts while also applying to local non-clique DDGP subproblems satisfying the theorem's hypotheses.
