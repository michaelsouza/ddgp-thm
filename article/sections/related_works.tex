...
Combinatorial DDGP keeps the clique condition on predecessor sets without requiring consecutive predecessors. Its no-pruning count is the closest positive DDGP counting result that our local formula recovers as a special case~\cite{abud2024impossible}.
