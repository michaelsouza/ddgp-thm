...
Let $\Theta$ be the real algebraic set of nondegenerate lateration parameters (predecessor coordinates and active edge lengths). 
The instance satisfies generic mirror separation if there exists a proper algebraic exceptional set $Z \subset \Theta$ such that, for all parameters in $\Theta \setminus Z$, any shift $h \notin \mathcal{K}_F$ and branch code $s$ satisfy
\[
