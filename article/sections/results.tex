...
\begin{proof}
By Theorem~\ref{thm:main}, $\Xi_F$ is an affine coset of $\mathcal{K}_F$, so $\lvert \Xi_F \rvert = 2^{\dim \mathcal{K}_F}$. Applying Lemma~\ref{lem:rank} (Branch-shift rank) gives the displayed exponent.
\end{proof}
